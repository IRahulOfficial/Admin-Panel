<?php    include '../data_base/connection.php' ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="post" action="../data_base/data_signup.php">
                  ...
                  <div class="form-group">
                    <input type="number" class="form-control form-control-lg" id="exampleInputnumber1" placeholder="Mobile No" name="mobileno" required>
                  </div>
                  <div class="form-group">
                    <select class="form-control form-control-lg" id="exampleFormControlSelect2" name="gender" required>
                      <option value="select gender" disabled selected >--SELECT--</option>
                  ...
                  <div class="mt-3">
                    <button name="submit" type="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html">SIGN UP</button>
                  </div>
